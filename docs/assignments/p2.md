...
7. Reporting  
    ...
    - Operational principle: when a user is reported by several other users, they are marked as reported  
8. Mapping  
...
## Storyboards
![](./project-images/storyboard1.jpg){:width='500'}

![](./project-images/storyboard2.jpg){:width='500'}